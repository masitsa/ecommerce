...
<?php
$page_title = array('name'=>'page_title','id'=>'page_title','value'=>set_value('page_title'));
$page_order = array('name'=>'page_order','id'=>'page_order','value'=>set_value('page_order'));
...
$post_page = array('name'=>'post_page','id'=>'post_page','value'=>1,'checked'=>$this->input->post('post_page'));
?>
<script>
 tinymce.init({
    selector: "textarea",
...
<div class="widget">
	<div class="widget-head">
		<div class="pull-left"><i class="icon-folder-close title"></i>Add Page</div>
		...
		<div class="padd">
			<?php echo form_open($this->uri->uri_string(),"class='form-horizontal'"); ?>
				...
				<div class="control-group">
					...
					<div class="controls">
						<?php echo form_dropdown('page_layout',$layouts_dropdown,$this->input->post('page_layout'),'class="span4" id="page_layout"');?>
						<span class="help-block">
				...
				<div class="control-group">
					...
					<div class="controls">
						<?php echo form_dropdown('parent',$parents_dropdown,$this->input->post('parent'),'class="span4"');?>
						<span class="help-block">
				...
				<div class="control-group page-content-left">
					...
					<div class="controls">
						<textarea name="page_content_left" id="page_content_left" class="span12"><?php echo $this->input->post('page_content_left')!='<br>'?$this->input->post('page_content_left'):''; ?></textarea>
						<span class="help-block">
				...
				<div class="control-group page-content-middle">
					...
					<div class="controls">
						<textarea name="page_content_middle" id="page_content_middle" class="span12"><?php echo $this->input->post('page_content_middle')!='<br>'?$this->input->post('page_content_middle'):''; ?></textarea>
						<span class="help-block">
				...
				<div class="control-group page-content-right">
					...
					<div class="controls">
						<textarea name="page_content_right" id="page_content_right" class="span12"><?php echo $this->input->post('page_content_right')!='<br>'?$this->input->post('page_content_right'):''; ?></textarea>
						<span class="help-block">
