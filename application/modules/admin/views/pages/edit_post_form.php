...
$post_position = array('name'=>'post_position','id'=>'post_position','value'=>$details->post_position);
if($details->active == 1)
	$active = array('name'=>'active','id'=>'active','value'=>1,'checked'=>TRUE);
else
	$active = array('name'=>'active','id'=>'active','value'=>1,'checked'=>FALSE);
		...
		<div class="padd">
			<?php echo form_open($this->uri->uri_string(),"class='form-horizontal'"); ?>
				...
				<div class="control-group">
					...
					<div class="controls">
						<?php echo form_dropdown('page',$pages_dropdown,$details->page);?>
						<span class="help-block">
				...
				<div class="control-group">
					...
					<div class="controls">
						<?php echo form_dropdown('column',$columns_dropdown,$details->column);?>
						<span class="help-block">
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea name="post_content" id="post_content" style="width:100%;"><?php echo $details->post_content!='<br>'?$details->post_content:''; ?></textarea>
						<span class="help-block">
