	...
	if(is_array($categories)){
		foreach($categories as $cat){
			...
			if(($category_parent == 0) || (empty($category_parent))){
                ...
                <li>
                	<p></p>
                    <a onClick="alert_here(<?php echo $category_id;?>)" href="#" class="sort_category"><?php echo $category_name;?></a>
                    <ul class="dl-submenu">
                    <?php
					...
					if(is_array($category_children)){
						...
						foreach($category_children as $cat2){
							...
							if($category_parent2 == $category_id){
                                ...
                                <li>
                                	<p></p>
                                	<a  onClick="alert_here(<?php echo $category_id2;?>)"  href="#" class="sort_category"><?php echo $category_name2;?></a>
                                    <ul class="dl-submenu">
                                <?php
									...
									$count2 = 0;
										...
										foreach($category_children as $cat3){
											...
											if($category_id2 == $category_parent3){
                                                ...
                                                <li>
                                                	<p></p>
                                                	<a onClick="alert_here(<?php echo $category_id3;?>)"  href="#" class="sort_category">
