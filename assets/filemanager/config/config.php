...
// root
//	|- assets
//	|	|- filemanager_uploads <- upload folder
//	|	|- filemanager_thumbs <- thumbnail folder [must have write permission (755)]
//	|	|- filemanager
//	|- js
//	|   |- tinymce
//	|   |   |- plugins
...
$base_url = "http://cms.dev";  // base url (only domain) of site (without final /). If you prefer relative urls leave empty


$upload_dir = '/assets/filemanager_uploads/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../filemanager_uploads/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../filemanager_thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
